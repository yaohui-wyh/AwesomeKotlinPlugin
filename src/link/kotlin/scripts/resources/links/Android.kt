...
val AkAndroid = category("Android") {
    subcategory("Libraries") {
        ...
        link {
            ...
            desc =
                "Android library for preferences which includes property delegates and a custom DSL for definining preferences."
        ...
        link {
            ...
            setTags(
                "kotlin", "kotlin-android", "android-utils",
        ...
        link {
            ...
            desc =
                "This Android library is a library that provides social login for 15 platforms powered by RxJava2, Kotlin and Firebase Authentication. "
    ...
    subcategory("Frameworks") {
        ...
        link {
            ...
            desc =
                "Open source cross platform mobile development framework that offers write once run anywhere native development for iOS (iPhone/iPad), Android, Windows & more using Kotlin & Java"
        ...
        link {
            ...
            desc =
                "Data binding and persistence infrastructure for building Android and JavaFX UIs and binding them with data"
        }
        link {
            github = "0xe1f/ararat"
            setPlatforms(ANDROID)
    ...
    subcategory("Projects") {
        ...
        link {
            ...
            desc =
                "A full exercise to learn how to create espresso tests using test doubles and a dependency injector for Android written in Kotlin."
        ...
        link {
            ...
            desc =
                "The real life Command/Ctrl + F - Android App that uses the Mobile Vision API to allow you to search for any occurrence of a text in a digital document."
        ...
        link {
            ...
            desc =
                "Currency Exchange App that displays real-time currency rates, shows a chart for any currency pair in the world to see their currency history and provides a currency converter."
            setTags(
                "kotlin",
                "mvvm",
                "android",
    ...
    subcategory("Multiplatform") {
        ...
        link {
            ...
            desc =
                "Multi-language framework for solving typical data security tasks: storage and messaging encryption, authentication, works for 14 languages."
    ...
    subcategory("Boilerplate") {
        link {
            ...
            desc =
                "A clean architecture boilerplate using android written in Kotlin and using the Model-View-Intent pattern"
        ...
        link {
            ...
            desc =
                "A clean architecture boilerplate using andorid architecture components for android written in Kotlin"
