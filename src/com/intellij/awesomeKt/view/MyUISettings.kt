...
class MyUISettings {
    ...
    val checkWidth: Int by lazy { JBUI.scale(16) }
    ...
    // FONTS
    val fontSize: Int by lazy { UISettings.getInstance().FONT_SIZE.ifZero(JBUI.scale(13)) }
    val fontFace: String by lazy { UISettings.getInstance().FONT_FACE ?: JLabel().font.fontName }
    ...
    private fun Int.ifZero(nonZeroValue: Int): Int = if (this == 0) nonZeroValue else this
}
